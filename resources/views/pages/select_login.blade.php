            ...
            <div class="flex flex-col lg:flex-row justify-center items-stretch gap-6">
                ...
                <div class="w-full bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="{{ route('student_login') }}" class="block w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition duration-200 font-medium">
                            Continue as Student
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="{{ route('admin_login') }}" class="block w-full bg-red-600 text-white py-2 rounded-md hover:bg-red-700 transition duration-200 font-medium">
                            Continue as Admin
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a href="{{ route('teacher_login') }}" class="block w-full bg-green-600 text-white py-2 rounded-md hover:bg-green-700 transition duration-200 font-medium">
                            Continue as teacher
                        </a>
                    </div>
                </div>
